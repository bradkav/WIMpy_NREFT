...
def Ni59(i,j,y):
    if i == 0 and j == 0:
        WM = (277.009129983598 - 732.4308479753286*y 
            ...
            + 0.33543918900384256*y**6)/exp(2.*y)
    elif i == 1 and j == 1:
        WM = (0.7161949885553599 - 2.864779954221512*y 
            ...
            + 0.0535951173286681*y**6)/exp(2.*y)
    else::
...
def Fe56(i,j,y):
    if i == 0 and j == 0:
        WM = (62.388777015508765 - 160.42824560643984*y 
                ...
                + 0.052529136733736465*y**6)/exp(2.*y)
    elif i == 1 and j == 1:
        WM = (0.31830868659112194 - 1.2732347463644877*y 
            ...
            + 0.009215248417080017*y**6)/exp(2.*y)
    else::
        WM = (-4.456331413823822 + 14.642230425862513*y 
            ...
            - 0.022001569128954065*y**6)/exp(2.*y)
    return WM
...
def Ar40(i,j,y):
    if i == 0 and j == 0:
        WM = (31.82942047318682 - 65.96177301433545*y 
            ...
            + 0.0005443287364681978*y**6)/exp(2.*y)
    elif i == 1 and j == 1:
        WM = (0.31830397368380947 - 1.0652376196047997*y 
            ...
            + 0.0004805126374568142*y**6)/exp(2.*y) 
    else::
        WM = (-3.1829908917036316 + 8.62424562744593*y 
            ...
            - 0.0005114262769978376*y**6)/exp(2.*y) 
    return WM

def S32(i,j,y):
    if i == 0 and j == 0:
        WM = (0.580304518771385*(5.9249403912693674 
            - 5.4311767953080805*y + 1.*y**2)**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def Si28(i,j,y):
    if i == 0 and j == 0:
        WM = (0.28169494679919466*(7.4408929931912215 
            - 6.377837355440523*y + 1.*y**2)**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def Ne20(i,j,y):
    if i == 0 and j == 0:
        WM = (0.04317233854151146*(13.576634514888733 
            - 9.051082784315225*y + 1.*y**2)**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def O16(i,j,y):
    if i == 0 and j == 0:
        WM = (0.000032627961876663305*(395.08421446634475 
            - 200.04237521164006*y + 1.*y**2)**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def N14(i,j,y):
    if i == 0 and j == 0:
        WM = (11.697894775374504 - 11.14085547491048*y 
            + 2.6757362417126016*y**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def C12(i,j,y):
    if i == 0 and j == 0:
        WM = (0.5658824249863367*(2.2500012041702315 - 1.*y)**2)/exp(2.*y)
    else::
        WM = 0.
    return WM
...
def He4(i,j,y):
    if i == 0 and j == 0:
        WM = 0.31830988618379064/exp(2.*y)
    else::
        WM = 0.
    return WM   
...
def Xe128(i,j,y):
    if i == 0 and j == 0:
       WM = (325.91917744944726 -
            ...
            0.0010369644490000852*y**9 + 3.016262813210672e-6*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (7.955427010079781 - 
            ...
            0.0006011228389940611*y**9 + 3.0162619877346335e-6*y**10)
            /exp(2.*y)
    else:: 
...
def Xe129(i,j,y):
    if i == 0 and j == 0:  
        WM = (662.0513124596586 - 
            ...
            0.0030896641999513196*y**9 + 0.000013570079859195202*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (17.536130437374922 - 
            ...
            0.0020509262978681644*y**9 + 0.000013570084170760142*y**10)
            /exp(2.*y)
    else:
        WM = (-107.7488662192223 + 
            ...
            0.002570295331418228*y**9 - 0.000013570082014977499*y**10)
            /exp(2.*y)
    return WM
...
def Xe130(i,j,y):
    if i == 0 and j == 0: 
        WM = (336.1724390248572 - 
            ...
            0.0016553468792303643*y**9 + 6.785766731805963e-6*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (9.624082154285077 - 
            ...
            0.0010502329799669098*y**9 + 6.785769077692495e-6*y**10)
            /exp(2.*y)
    else:
        WM = (-56.880147425807706 + 
            ...
            0.0013527899818966645*y**9 - 6.785767904749128e-6*y**10)
            /exp(2.*y)
    return WM
...
def Xe131(i,j,y):
    if i == 0 and j == 0: 
        WM = (1365.516293403943 - 
            ...
            0.008910040822607978*y**9 + 0.00004893187896953263*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (42.07823482867425 - 
            ...
            0.0062981742105538575*y**9 + 0.00004893185064701238*y**10)
            /exp(2.*y)
    else:
        WM = (-239.70505888744214 + 
            ...
            0.007604107139583628*y**9 - 0.00004893186480827043*y**10)
            /exp(2.*y)
    return WM
...
def Xe132(i,j,y):
    if i == 0 and j == 0: 
        WM = (346.6240402968277 - 
            ...
            0.002348294149691664*y**9 + 0.000012063984104347794*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (11.45649049509185 - 
            ...
            0.001591310553873739*y**9 + 0.000012063983920449166*y**10)
            /exp(2.*y)
    else:
       WM = (-63.01662497334288 + 
          ...
          0.0019698023488979115*y**9 - 0.00001206398401239848*y**10)
          /exp(2.*y)
       return WM
...
def Xe134(i,j,y):
    if i == 0 and j == 0: 
        WM = (357.14940205207637 - 
            ...
            0.0034715055289740405*y**9 + 0.00002466424268052468*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (13.435047170827318 - 
            ...
            0.002558900020389506*y**9 + 0.00002339737814666577*y**10)
            /exp(2.*y)
    else:
        WM = (-69.26990012698448 + 
            ...
            0.0030042188677877352*y**9 - 0.000024022460587903342*y**10)
            /exp(2.*y)
    return WM
...
def Xe136(i,j,y):
    if i == 0 and j == 0: 
        WM = (367.96567413977306 - 
            ...
            0.0039439153848192824*y**9 + 0.000027829597283496683*y**10)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (15.597112953911047 - 
            ...
            0.002972955344062032*y**9 + 0.000026475337573894588*y**10)
            /exp(2.*y)
    else: 
        WM = (-75.75752228472138 + 
            ...
            0.003447400582383077*y**9 - 0.00002714402296318868*y**10)
            /exp(2.*y)
    return WM
...
def Ge70(i,j,y):
    if i == 0 and j == 0: 
        WM = (97.43901858328331 - 
           ...
           0.0036473157269272544*y**7 + 0.000011156219115261747*y**8)
           /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (0.7135382911521365 - 
            ...
            0.0009643953789455854*y**7 + 9.381587277483851e-6*y**8)
            /exp(2.*y)
    else:
        WM = (-8.338253462893594 + 
            ...
            0.002198164100524073*y**7 - 0.000010230495751260627*y**8)
            /exp(2.*y)
    return WM
...
def Ge72(i,j,y):
    if i == 0 and j == 0: 
        WM = (103.12612235890246 - 
            ...
            0.0015875051209515458*y**7 + 1.7019745402803562e-6*y**8)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (1.2727170238658878 - 
            ...
            0.00022191507606288453*y**7 + 4.82578274801601e-7*y**8)
            /exp(2.*y)
    else:
        WM = (-11.456455452340036 
            ...
            0.0006310381532129546*y**7 - 9.062758616474026e-7*y**8)
            /exp(2.*y)
    return WM
...
def Ge73(i,j,y):
    if i == 0 and j == 0: 
        WM = (1059.9984768015083 - 
            ...
            0.05559197080463813*y**7 + 0.0002664666814177836*y**8)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (16.097628126297593 - 
            ...
            0.016134491711799752*y**7 + 0.00022414740150650264*y**8)
            /exp(2.*y)
    else:
        WM = (-130.62718436065458 + 
            ...
            0.03354945772954588*y**7 - 0.00024381979068201202*y**8)
            /exp(2.*y)
    return WM
...
def Ge74(i,j,y):
    if i == 0 and j == 0: 
        WM = (108.90027213248975 - 
            ...
            0.009343970989624863*y**7 + 0.00004860192450703234*y**8)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (1.9848881662359417 - 
            ...
            0.0037885556718445807*y**7 + 0.00004398616462192064*y**8)
            /exp(2.*y)
    else:
        WM = (-14.702206006435004 + 
            ...
            0.006435789654944067*y**7 - 0.00004623648183316377*y**8)
            /exp(2.*y)
    return WM
...
def Ge76(i,j,y):
    if i == 0 and j == 0: 
        WM = (114.84250951391134 - 
            ...
            0.017678888760929084*y**7 + 0.0001396692245663162*y**8)
            /exp(2.*y)
    elif i == 1 and j == 1:
        WM = (2.8559560199080845 - 
            ...
            0.00870447604347527*y**7 + 0.00013359576196805535*y**8)
            /exp(2.*y)
    else:
        WM = (-18.110360470946112 + 
            ...
            0.013095186551368621*y**7 - 0.00013659874259825544*y**8)
            /exp(2.*y)
    return WM
...
def Na23(i,j,y):
    if i == 0 and j == 0:
        ...
        6.578783535849091*y**3 + 0.48316606974351767*y**4)/exp(2.*y)
    elif i == 1 and j == 1:
        WM = (0.0795775779268156 - 
        0.21220687447151282*y + 0.18294073140422737*y**2 - 
        0.05438917569436889*y**3 + 0.005230123402896642*y**4)
        /exp(2.*y)
    else: 
        WM = (-1.830283007390508 + 
        3.819721028793027*y - 2.504451490051804*y**2 + 
        0.59782183594923*y**3 - 0.04545001570392015*y**4)/exp(2.*y)
    return WM   
...
def Iodine(i,j,y):
    if i == 0 and j == 0:
        WM = (1925.2494842126675 - 7519.078481114949*y 
            ...
            + 0.000018233156754955732*y**10)/exp(2.*y)
    elif i == 1 and j == 1:
        WM = (52.63920342374225 - 294.1112093604512*y 
            ...
            + 0.000018233156078074516*y**10)/exp(2.*y)
    else:
        WM = (-318.3450945765076 + 1510.9950997182093*y
            ...
            - 0.000018233156416515106*y**10)/exp(2.*y)
    return WM
